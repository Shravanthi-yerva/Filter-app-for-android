        ...
        switch(requestCode){
            case MY_PERMISSIONS_REQUEST_STORAGE_PERMISSION:
                if(grantResults.length>0 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    new MaterialDialog.Builder(ControlActivity.this).title("Permission Requires")
                            .content("Thank you for granting permission")
                            .negativeText("Now")
                            .positiveText("Yes").canceledOnTouchOutside(true).show();
                }
                else{
